...
def create_contents_of_a_typst_file_from_a_yaml_string(
    ...
    try:
        ...
        # Let YAML parsing errors propagate, as they are different from validation errors
        raise e
    return create_contents_of_a_typst_file_from_a_python_dictionary(input_file_as_a_dict)
...
def create_contents_of_a_markdown_file_from_a_yaml_string(
    ...
    try:
        ...
        raise e
    return create_contents_of_a_markdown_file_from_a_python_dictionary(
        input_file_as_a_dict
    )
...
def create_a_typst_file_from_a_yaml_string(
    ...
    Returns:
        None if successful, otherwise a list of dictionaries containing validation
            errors.
    ...
    try:
        ...
        raise e
    return create_a_typst_file_from_a_python_dictionary(
        input_file_as_a_dict, output_file_path
    )
...
def create_a_markdown_file_from_a_yaml_string(
    ...
    try:
        ...
        raise e
    return create_a_markdown_file_from_a_python_dictionary(
        input_file_as_a_dict, output_file_path
    )
...
def create_an_html_file_from_a_yaml_string(
    ...
    try:
        ...
        raise e
    return create_an_html_file_from_a_python_dictionary(
        input_file_as_a_dict, output_file_path
    )
...
def create_a_pdf_from_a_yaml_string(
    ...
    try:
        ...
        raise e
    return create_a_pdf_from_a_python_dictionary(
        input_file_as_a_dict, output_file_path
    )
